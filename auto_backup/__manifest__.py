...
The base of this module is taken from Odoo SA V6.1 (https://www.odoo.com/apps/modules/6.0/auto_backup/) and then upgraded and expanded.
This module is made and provided by Sayapatri Technology
Automatic backup for all configured databases can then be scheduled as follows:  
