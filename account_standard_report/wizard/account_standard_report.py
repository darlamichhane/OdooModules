...
class AccountStandardLedger(models.TransientModel):
    ...
    type_ledger = fields.Selection([('general', 'General Ledger')], string='Type', default='general', required=True,
    ...
    journal_ids = fields.Many2many('account.journal', string='Journals', required=True,domain=[('type', '=', 'voucher')], default=lambda self: self.env['account.journal'].search([('type', '=', 'voucher')]),
